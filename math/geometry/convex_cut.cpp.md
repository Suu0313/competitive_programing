...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/geometry/convex_cut.cpp\"\n\r\n#line 2 \"math/geometry/Geometry.cpp\"\
    ...
    \ (is);\r\n  }\r\n};\r\n#line 4 \"math/geometry/convex_cut.cpp\"\n\r\ntemplate<typename\
    \ T>\r\npair<Polygon<T>,Polygon<T>> convex_cut(const Polygon<T> &ps, const Line<T>\
    \ &l){\r\n  Polygon<T> lres, rres;\r\n  int n = ps.size();\r\n  for(int i = 0;\
    \ i < n; i++){\r\n    int j = (i+1==n) ? 0 : (i + 1);\r\n    int a = iSP(l.a,\
    \ l.b, ps[i]), b = iSP(l.a, l.b, ps[j]);\r\n    if(a != -1) lres.emplace_back(ps[i]);\r\
    \n    if(a != 1) rres.emplace_back(ps[i]);\r\n    if(a*b < 0){\r\n      auto p\
    \ = Line(ps[i], ps[j]).cross_point(l);\r\n      lres.emplace_back(p); rres.emplace_back(p);\r\
  ...
  verifiedWith: []
documentation_of: math/geometry/convex_cut.cpp
layout: document
redirect_from:
- /library/math/geometry/convex_cut.cpp
- /library/math/geometry/convex_cut.cpp.html
