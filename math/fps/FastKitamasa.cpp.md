...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/fps/FastKitamasa.cpp\"\n\r\n#line 2 \"math/fps/Formalpowerseries.cpp\"\
    ...
    \n    }\r\n    return res.pre(d);\r\n  }\r\n};\r\n#line 4 \"math/fps/FastKitamasa.cpp\"\
    \n\r\ntemplate<typename T>\r\nT FastKitamasa(const Formalpowerseries<T> &c, const\
    \ Formalpowerseries<T> &a, long long n){\r\n  Formalpowerseries<T> d({1}), xn({0,\
    \ 1}), f(-c);\r\n  f.push_back(1);\r\n  while(n){\r\n    if(n & 1) d = d * xn\
    \ % f;\r\n    xn = xn * xn % f;\r\n    n >>= 1;\r\n  }\r\n  return a.dot(d).eval(1);\r\
    \n}\r\n"
  code: "#pragma once\r\n\r\n#include \"./Formalpowerseries.cpp\"\r\n\r\ntemplate<typename\
    \ T>\r\nT FastKitamasa(const Formalpowerseries<T> &c, const Formalpowerseries<T>\
  ...
  verifiedWith: []
documentation_of: math/fps/FastKitamasa.cpp
layout: document
redirect_from:
- /library/math/fps/FastKitamasa.cpp
- /library/math/fps/FastKitamasa.cpp.html
