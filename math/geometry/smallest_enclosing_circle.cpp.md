...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/geometry/smallest_enclosing_circle.cpp\"\n\r\n#line\
    \ 2 \"math/geometry/Geometry.cpp\"\n\r\n#line 2 \"math/geometry/geometry_base.cpp\"\
    ...
    \ (is);\r\n  }\r\n};\r\n#line 4 \"math/geometry/smallest_enclosing_circle.cpp\"\
    \n\r\ntemplate<typename T>\r\nCircle<T> smallest_enclosing_circle(Polygon<T> ps){\r\
  ...
  code: "#pragma once\r\n\r\n#include \"./Geometry.cpp\"\r\n\r\ntemplate<typename\
    ...
    \n  if(n == 1) return Circle<T>(ps[0], 0);\r\n  random_device seed;\r\n  mt19937\
    \ rng(seed());\r\n  shuffle(ps.begin(), ps.end(), rng);\r\n  Circle<T> c(ps[0],\
    \ ps[1]);\r\n  for(int i = 2; i < n; i++){\r\n    if(c.contains(ps[i]) != 2) continue;\r\
    \n    c = Circle<T>(ps[0], ps[i]);\r\n    for(int j = 1; j < i; j++){\r\n    \
    \  if(c.contains(ps[j]) != 2) continue;\r\n      c = Circle<T>(ps[i], ps[j]);\r\
    \n      for(int k = 0; k < j; k++){\r\n        if(c.contains(ps[k]) != 2) continue;\r\
    \n        c = Circle<T>(ps[i], ps[j], ps[k]);\r\n      }\r\n    }\r\n  }\r\n \
    \ return c;\r\n}\r\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: math/geometry/smallest_enclosing_circle.cpp
layout: document
redirect_from:
- /library/math/geometry/smallest_enclosing_circle.cpp
- /library/math/geometry/smallest_enclosing_circle.cpp.html
