...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/fps/multipoint_evaluation.cpp\"\n\r\n#line 2 \"math/fps/Formalpowerseries.cpp\"\
  ...
  code: "#pragma once\r\n\r\n#include \"./Formalpowerseries.cpp\"\r\n\r\ntemplate<\
    \ typename T >\r\nvector<T> multipoint_evaluation(const Formalpowerseries<T> &f,\
    \ const vector<T> &xs){\r\n  int n0 = int(xs.size()), n = 1;\r\n  while(n < n0)\
    \ n <<= 1;\r\n  vector<Formalpowerseries<T>> g(n*2, {1});\r\n  for(int i = 0;\
    \ i < n0; ++i) g[i+n] = {-xs[i], 1};\r\n  for(int i = n-1; i > 0; --i) g[i] =\
    \ g[i*2] * g[i*2 + 1];\r\n\r\n  g[1] = f % g[1];\r\n  for(int i = 2; i < n + n0;\
  ...
  verifiedWith: []
documentation_of: math/fps/multipoint_evaluation.cpp
layout: document
redirect_from:
- /library/math/fps/multipoint_evaluation.cpp
- /library/math/fps/multipoint_evaluation.cpp.html
