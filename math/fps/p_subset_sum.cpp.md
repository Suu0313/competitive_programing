...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/fps/p_subset_sum.cpp\"\n\r\n#line 2 \"math/fps/Formalpowerseries.cpp\"\
    ...
    \n    }\r\n    return res.pre(d);\r\n  }\r\n};\r\n#line 4 \"math/fps/p_subset_sum.cpp\"\
    \n\r\ntemplate<typename T>\r\nFormalpowerseries<T> p_subset_sum(const vector<int>\
    \ &a, int s){\r\n  vector<T> cnt(s + 1);\r\n  for(auto&e : a) if(e <= s) ++cnt[e];\r\
    \n\r\n  vector<T> inv(s + 1, 1);\r\n  int mod = T::get_mod();\r\n  for(int i =\
    \ 2; i <= s; ++i) inv[i] = -inv[mod % i] * (mod / i);\r\n\r\n  Formalpowerseries<T>\
    \ f(s + 1);\r\n  for(int i = 1; i <= s; ++i){\r\n    for(int k = 1; k*i <= s;\
  ...
  verifiedWith: []
documentation_of: math/fps/p_subset_sum.cpp
layout: document
redirect_from:
- /library/math/fps/p_subset_sum.cpp
- /library/math/fps/p_subset_sum.cpp.html
