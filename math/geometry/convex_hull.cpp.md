...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/geometry/convex_hull.cpp\"\n\r\n#line 2 \"math/geometry/Point.cpp\"\
  ...
  code: "#pragma once\r\n\r\n#include \"./Point.cpp\"\r\n\r\ntemplate<typename T>\r\
    ...
    \ k = 0;\r\n  sort(ps.begin(), ps.end());\r\n  Polygon<T> res(2 * n);\r\n  auto\
    \ check = [&](int i){\r\n    if(strict) return geometry::le(T(0), res[k - 1].cross(res[k\
    \ - 2], ps[i]));\r\n    return geometry::lt(T(0), res[k - 1].cross(res[k - 2],\
  ...
  verifiedWith: []
documentation_of: math/geometry/convex_hull.cpp
layout: document
redirect_from:
- /library/math/geometry/convex_hull.cpp
- /library/math/geometry/convex_hull.cpp.html
