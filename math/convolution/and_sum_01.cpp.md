...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"math/convolution/and_sum_01.cpp\"\n\r\n#line 2 \"math/mod/ModInt.cpp\"\
    \n\r\ntemplate< int mod >\r\nstruct ModInt {\r\n  int x;\r\n\r\n  constexpr ModInt()\
  ...
  code: "#pragma once\r\n\r\n#include \"../mod/ModInt.cpp\"\r\n#include \"../fps/NTT.cpp\"\
    ...
    \ 0 or 1\r\n*/\r\nvector<int> and_sum_01(const vector<int> &a, const vector<int>\
    \ &b){\r\n  assert(a.size() == b.size());\r\n  int n = int(a.size());\r\n  using\
    \ mint = mint998244353;\r\n  vector<mint> ma(n * 2), mb(n);\r\n  for(int i = 0;\
    \ i < n; ++i) ma[i] = ma[i + n] = a[i];\r\n  for(int i = 0; i < n; ++i) mb[i]\
  ...
  verifiedWith: []
documentation_of: math/convolution/and_sum_01.cpp
layout: document
redirect_from:
- /library/math/convolution/and_sum_01.cpp
- /library/math/convolution/and_sum_01.cpp.html
title: c[k] = sum (a[i + k] & b[i])
---
