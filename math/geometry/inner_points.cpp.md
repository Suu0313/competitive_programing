...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/geometry/inner_points.cpp\"\n\r\n#line 2 \"math/geometry/Point.cpp\"\
    ...
    \ &ps){\r\n  sort(begin(ps), end(ps), cmp_arg<T>);\r\n}\r\n#line 4 \"math/geometry/inner_points.cpp\"\
    \n\r\ntemplate<typename T>\r\npair<int64_t, int64_t> inner_points(const Polygon<T>\
    \ &ps){\r\n  int n = int(ps.size());\r\n  if(n < 2) return {0, n};\r\n  if(n ==\
    \ 2){\r\n    auto[x, y] = ps[0] - ps[1];\r\n    return {0, gcd(x, y) + 1};\r\n\
  ...
  verifiedWith: []
documentation_of: math/geometry/inner_points.cpp
layout: document
redirect_from:
- /library/math/geometry/inner_points.cpp
- /library/math/geometry/inner_points.cpp.html
